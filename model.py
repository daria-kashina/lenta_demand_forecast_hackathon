...
def forecast(sales: dict, item_info: dict, store_info: dict) -> list:
    ...
    product_labels = pd.read_csv('products_labels.csv')
    ...
    prophet_m = joblib.load('proph.pkl')
    ...
    holidays_df = pd.read_csv('holidays_covid_calendar.csv')
    ...
    model_price = joblib.load('model_price_2.pkl')
    model_units = joblib.load('model_cb-2.pkl')
